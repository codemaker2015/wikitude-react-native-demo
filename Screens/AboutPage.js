    ...
    <SafeAreaView styles={styles.safearea}>
      <View style={styles.card}>
        <Image
          ...
          source={require('../res/author.jpg')}
        />
        <Text style={styles.titleCompany}>VSOFT</Text>
        <Text style={styles.descriptionCompany}> Develop by Vishnu Sivan</Text>
        <View style={styles.buttonsContainer}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              openUrl('mailto:codemaker2015@gmail.com');
            }}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              openUrl('https://www.linkedin.com/in/codemaker2015');
            }}>
